...
class SceneMain extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON('dungeonMap', "../../../Dungeon.tmj");
  }
  ...
  create() {
    ...
    const TilesLayer = map.createLayer("Tiles", tileset1, 0, 0);
    const SpriteLayer = map.createLayer("Sprites", tileset2, 0, 0);
    const floorLayer = map.createLayer("Floor",tileset3,0,0)
